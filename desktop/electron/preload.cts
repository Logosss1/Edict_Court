...
contextBridge.exposeInMainWorld('edictDesktop', {
  ...
  revealProviderKey: (providerId: string) => ipcRenderer.invoke('provider:reveal', providerId),
  ...
  revealProjectFile: (path: string) => ipcRenderer.invoke('workspace:reveal-file', path),
